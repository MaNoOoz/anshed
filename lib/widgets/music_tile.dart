...
class MusicTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Logger().e("$isCurrentSong + ${playerController.currentSongName.value}");
    return GetBuilder<PlayerController>(
        id: 'song_$index', // مفتاح فريد لكل عنصر
              ...
              child: ListTile(
                ...
                onTap: () async {
                  ...
                  playerController.update([
                    'song_$index',
                    'song_${playerController.currentIndex.value}'
                  ]);
                  Logger().d('$index ${playerController.currentIndex.value}');
                },
              ),
            ),
          );
